...
INSERT INTO category(name, season) VALUES
('Ski', 'Hiver'),
('Snowboard', 'Hiver'),
('Raquettes', 'Hiver'),
('Rando', 'Été'),
...
('Snowboard Line APO',"La Line est une planche signée Apo Snowboards, un modèle typé freestyle mais doté d’une construction légèrement directionnelle pour gagner en conduite et en polyvalence.",528.90,'https://glisshop-glisshop-fr-storage.omn.proximis.com/Imagestorage/imagesSynchro/735/735/fce82a533507a973ee2d24a49eaf985feb1052ce_VH19APOBOA005_DESSUS.jpeg',20,false,2,'homme'),
('Snowboard First Lite K2',"La First Lite est une planche snowboard femme très accessible développée par K2. Elle permet de débuter en douceur et de progresser à votre rythme dans toute la station.",449.80,'https://glisshop-glisshop-fr-storage.omn.proximis.com/Imagestorage/imagesSynchro/735/735/ba5168b8e053cdd8571d300513e6ad401f399043_VH20K2BOA012_DESSUS.jpeg',0,false,2,'femme'),
('TSL 325 Pioneer',"Rigides et aux réglages très simples, ces raquettes à neige 305 Pionner de chez TSL outdoor sont idéales pour les débutants ou adeptes de la balade facile.",129.95,'https://www.snowuniverse.com/10527-large_default/tsl-325-pioneer.jpg',30,false,3,'homme'),
('TSL - 206 Rando',"Dignes successeurs des 205 & 225 Rando, les modèles 206 & 226 Rando conservent leurs qualités : rigidité, bonne accroche latérale et portance sécurisante avec le volume et le design en plus.",129.00,'https://www.snowuniverse.com/11068-large_default/tsl-206-rando.jpg',15,false,3,'femme');

INSERT INTO user(firstname,lastname,email,password, address, zip, city, role) VALUES
('Ludivine', 'Coujard', 'lud@exemple.com', '$argon2i$v=19$m=4096,t=3,p=1$Ti6dBG4ZKowYjSFlVnSTMMXQTnjb+6wb0nvLOjmFYBM$HELCkbLv8BlH/23o/IIR08qopUcYdFPn26al0PwXMR8', '2 rue Chabert', '69400', 'Villefranche-sur-Saône', 'admin');